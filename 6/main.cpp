...
GLfloat vertexData[] = {
    ...
    // al doilea triunghi
    0.1f, 8.0f, 0.0f, 0.0f, 1.0f,
    5.1f, 0.0f, 0.0f, 1.0f, 1.0f,
    10.1f, 8.0f, 0.0f, 0.5f, 0.0f
};
...
void windowResizeCallback(GLFWwindow *window, int width, int height) {
    ...
    glm::mat4 projection = glm::perspective(glm::radians(55.0f), (float) width / (float) height, 0.1f, 1000.0f);
...
int main(int argc, const char *argv[]) {
    ...
    glm::mat4 projection = glm::perspective(glm::radians(55.0f), (float) retina_width / (float) retina_height, 0.1f,
                                            1000.0f);
    //send matrix data to shader
    GLint projLoc = glGetUniformLocation(myCustomShader.shaderProgram, "projection");
    glUniformMatrix4fv(projLoc, 1, GL_FALSE, glm::value_ptr(projection));
