...
void initSkyBox() {
    ...
    faces2.push_back("skybox/negx.jpg");
    faces2.push_back("skybox/negy.jpg");
    faces2.push_back("skybox/negz.jpg");
    faces2.push_back("skybox/posx.jpg");
    faces2.push_back("skybox/posy.jpg");
    faces2.push_back("skybox/posz.jpg");
    mySkyBox.Load(faces);
}
